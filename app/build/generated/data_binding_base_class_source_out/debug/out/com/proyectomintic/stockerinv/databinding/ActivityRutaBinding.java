...
public final class ActivityRutaBinding implements ViewBinding {
  ...
  @NonNull
  public final TextInputEditText inputDestinoText;

  @NonNull
  public final TextInputEditText inputOrigenText;
  ...
  private ActivityRutaBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextInputEditText inputDestinoText, @NonNull TextInputEditText inputOrigenText,
      @NonNull TextView textViewDistancia, @NonNull TextView textViewDuracion) {
  ...
  public static ActivityRutaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextInputEditText inputDestinoText = ViewBindings.findChildViewById(rootView, id);
      if (inputDestinoText == null) {
        break missingId;
      }

      id = R.id.inputOrigenText;
      TextInputEditText inputOrigenText = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityRutaBinding((ConstraintLayout) rootView, CardViewMapa, InputDestino,
          InputOrigen, buttonContinuar, cardViewIngresoDestino, imageView, inputDestinoText,
          inputOrigenText, textViewDistancia, textViewDuracion);
    }

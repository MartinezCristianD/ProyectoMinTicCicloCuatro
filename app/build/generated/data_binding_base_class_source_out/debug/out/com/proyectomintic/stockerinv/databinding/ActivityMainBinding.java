...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialButton ingresoGoogle;
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextInputLayout crearClave, @NonNull MaterialButton ingresoGoogle,
      @NonNull TextInputLayout registroCorreo, @NonNull TextView textAunSinCuenta,
      @NonNull TextView textoOlvidoContraseA) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      MaterialButton ingresoGoogle = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, botonIngreso, botonRegistro,
          buttonInvitado, cardViewLogin, crearClave, ingresoGoogle, registroCorreo,
          textAunSinCuenta, textoOlvidoContraseA);
    }
